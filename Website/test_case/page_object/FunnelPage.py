...
class FunnelPage(Page):
    ...
    see6_loc = (By.XPATH, "//li[text()='Apple品牌列表页']")
    see7_loc = (By.XPATH, "//li[text()='停留']")
    see8_loc=(By.XPATH,"//li[text()='3 天']")
    ...
    def funnel_action1(self):
        ...
        sleep(1)
        self.type_click1(*self.type1_loc)
        sleep(1.5)
        self.type_click1(*self.see1_loc)
        sleep(2)
        self.type_click1(*self.page_loc)
        sleep(1)
        self.type_click1(*self.see2_loc)
        sleep(1)
        self.type_click(*self.addfunnel_loc)
        sleep(1)
        self.type_click(*self.page_loc)
        sleep(1)
        self.type_click1(*self.see3_loc)
        sleep(1)
        self.type_click(*self.type_loc)
        sleep(1)
        self.type_click1(*self.see7_loc)
        sleep(1)
        self.type_click(*self.addfunnel_loc)
        sleep(1)
        self.type_click(*self.page_loc)
        sleep(1)
        self.type_click1(*self.see4_loc)
        sleep(1)
        self.type_click(*self.event_loc)
        sleep(1)
        self.type_click1(*self.see5_loc)
        sleep(1)
        ...
        sleep(1)
        self.type_click1(*self.see8_loc)
        sleep(1)
    ...
    def funnel_action3(self):
        self.type_click1(*self.changebutton_loc)
        sleep(1)
        self.type_click(*self.addfunnel_loc)
        sleep(1)
        self.type_click(*self.page_loc)
        sleep(1)
        self.type_click1(*self.see6_loc)
        sleep(1)
        self.type_click1(*self.type_loc)
        sleep(1)
        self.type_click(*self.done_loc)
        sleep(1)
        self.driver.execute_script("""
    ...
    def funnel_action5(self):
        self.type_click1(*self.drop_loc)
        sleep(1)
        self.type_click1(*self.see9_loc)
        sleep(1)
